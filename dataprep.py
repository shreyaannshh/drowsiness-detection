...
for dirpath, dirname, filename in os.walk(raw_data):
 ...
 def create_test_closed(source, destination, percent):
    ...
    create_test_closed('/home/delixus/Desktop/drowsiness_detection/data/train/closed', '/home/delixus/Desktop/drowsiness_detection/data/test/closed', 0.2)
    
    create_test_open('/home/delixus/Desktop/drowsiness_detection/data/train/open', '/home/delixus/Desktop/drowsiness_detection/data/test/open',  0.2)
